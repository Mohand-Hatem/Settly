...
## 4. The advisory-lock invariants (I9, I11, I12)
...
⚠️ **A naive count-then-insert is incorrect for all three** — this is a common implementation
...
| T6 | Offline sale (P11) | Property→SOLD, supersede offers, cancel payments, Notification, AuditLog |
